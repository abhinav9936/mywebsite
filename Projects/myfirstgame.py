...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pick=pygame.image.load("car1.jpg")
    elif obs==1:
        obs_pick=pygame.image.load("car2.jpg")
    elif obs==2:
        obs_pick=pygame.image.load("car3.jpg")
    gamedisplays.blit(obs_pick,(obs_startx,obs_starty))
