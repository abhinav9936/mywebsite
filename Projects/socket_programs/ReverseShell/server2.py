import socket
import sys #to write terminal commands
import threading
import time
...
#Closing the previous connections when server.py file is restarted
...
# 2nd thread functions-1)See all the clients 2)Select a client 3)Sendion commands to that client
